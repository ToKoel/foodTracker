...
import { IonDatetime, IonIcon, IonItem, IonItemOption, IonItemOptions, IonItemSliding, IonLabel, IonList } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [IonItemSliding, IonDatetime, IonItemOptions, IonItemOption, IonIcon, IonItem, IonLabel, IonList, CommonModule, AddEntryComponent],
})
